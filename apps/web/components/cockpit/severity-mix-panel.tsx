  ...
  return (
    <section className="flex flex-col">
      ...
      <div className="space-y-2 px-3 py-3">
        <div className="flex h-1.5 w-full overflow-hidden border border-neutral-200">
          <div
            className="bg-black"
        ...
        <ul className="grid grid-cols-3 gap-1 font-mono text-[10px] uppercase tracking-widest text-neutral-600">
          <li>
