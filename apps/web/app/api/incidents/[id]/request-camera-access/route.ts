...
export async function POST(
  ...
  const b = parsed.data;
  // The privileged flags are derived server-side from the chosen basis,
  // not accepted from the client — keeps the enforcer contract honest.
  ...
  if (error) {
    console.error("[request-camera-access] rpc error:", error);
